...
// Begin locale-compiled/it_IT.js
ZLoc.init("it_IT", {"Inbox":{"listNames":{"original":"{commaDelimNames} e {finalName}"},"followUpCTASendGiftBack":{"original":"Ricambia il regalo"},"followUpCTASendGift":{"original":"Invia un regalo"},"followUpInviteTitle":{"original":"Ora tu e {listNames} siete vicini."},"followUpInviteBody":{"original":"Vuoi mandare un saluto inviando in regalo: {gift}?"},"followUpGiftBody":{"original":"Vuoi inviare un regalo di ringraziamento a {listNames}?"},"followUpCrewBody":{"original":"Vuoi inviare {gift} a {listNames}?"},"formatCTAAccept":{"original":"Accetta"},"formatCTAAcceptAll":{"original":"Accetta tutto"},"formatCTAAcceptSee":{"original":"Accetta e vedi"},"formatCTAAcceptSend":{"original":"Accetta e invia"},"formatCTAAcceptOnly":{"original":"Accetta solo"},"formatCTAHelp":{"original":"Aiuta"},"formatCTASendGiftBack":{"original":"Ricambia il regalo"},"formatCTASendGift":{"original":"Invia regalo"},"formatCTASendGifts":{"original":"Invia regali"},"formatGiftAggregateTitle":{"original":"Hai ricevuto: {number} {gift}."},"formatGiftAggregateBody":{"original":"Vuoi accettare il regalo e inviarne uno in cambio a {listNames}?"},"formatGiftSingleTitle":{"original":"{name1} ti ha inviato: {gift}."},"formatGiftSingleBody":{"original":"Vuoi accettare il regalo e inviarne uno in cambio a {name1}?"},"formatInviteAggregateTitle":{"original":"Hai {number} {neighbors,object,count}.","variations":["Hai {number} {neighbors,fem,plural}.","Hai {number} {neighbors,fem,singular}.","Hai {number} {neighbors,masc,plural}.","Hai {number} {neighbors,masc,singular}."]},"neighbors":{"original":"un invito nel vicinato","variations":{"indefinite_singular":"un invito nel vicinato","singular":"invito nel vicinato","plural":"inviti nel vicinato","indefinite_plural":"degli inviti nel vicinato","definite_plural":"gli inviti nel vicinato","definite_singular":"l'invito nel vicinato"},"gender":"masc"},"formatInviteAggregateSubText":{"original":"{listNames}"},"formatInviteAggregateBody":{"original":"Fai sapere che hai accettato!"},"formatInviteSingleTitle":{"original":"{name1} vuole che diventiate vicini su {game}."},"formatInviteSingleBody":{"original":"Accetti?"},"formatHelpAggregateTitle":{"original":"Ai tuoi amici serve: {type}."},"formatHelpAggregateBody":{"original":"Fai sapere loro che vorresti aiutare."},"formatHelpAggregateSubText":{"original":"{listNames}"},"formatHelpSingleTitle":{"original":"{name1} ha inviato:"},"formatHelpSingleBody":{"original":"Ehi! Potresti aiutarmi inviandomi: {type}?"},"formatCrewAggregateTitle":{"original":"Ai tuoi amici serve aiuto per costruire: {type}."},"formatCrewAggregateBody":{"original":"Fai sapere loro che parteciperai."},"formatCrewAggregateSubText":{"original":"{listNames}"},"formatCrewSingleTitle":{"original":"{name1} ha inviato:"},"formatCrewSingleBody":{"original":"Ho bisogno di te nel personale di {crew} nella mia citt\u00e0!"},"formatNotifSingleTitle":{"original":"{name1} ti ha inviato un oggetto che hai richiesto."},"formatNotifSingleBody":{"original":"Ricambia il regalo per ringraziare!"},"formatNotifAggregateTitle":{"original":"I tuoi amici ti hanno inviato degli oggetti che hai richiesto."},"formatNotifAggregateBody":{"original":"Ricambia il regalo per ringraziare!"},"formatNotifAggregateSubText":{"original":"{listNames}"},"formatExpiredTitle":{"original":"Avevi ricevuto delle richieste da {number} {friends,object,count} ormai scadute! Torna pi\u00f9 spesso!","variations":["{number} {friends,fem,plural} ti avevano inviato delle richieste ormai scadute! Torna pi\u00f9 spesso!","{number} {friends,fem,singular} ti aveva inviato delle richieste ormai scadute! Torna pi\u00f9 spesso!","{number} {friends,masc,plural} ti avevano inviato delle richieste ormai scadute! Torna pi\u00f9 spesso!","{number} {friends,masc,singular} ti aveva inviato delle richieste ormai scadute! Torna pi\u00f9 spesso!"]},"formatExpiredBody":{"original":"Invia a {listNames} un regalo di ringraziamento: {gift}"},"groupGift":{"original":"Regalo"},"groupGifts":{"original":"Regali"},"groupInvite":{"original":"Invito nel vicinato"},"groupInvites":{"original":"Inviti nel vicinato"},"groupHelp":{"original":"Richiesta di aiuto"},"groupHelps":{"original":"Richieste di aiuto"},"groupCrew":{"original":"Invito nel personale"},"groupCrews":{"original":"Inviti nel personale"},"groupFactory":{"original":"Invito in fabbrica"},"groupFactories":{"original":"Inviti in fabbrica"},"groupNotif":{"original":"Notifica"},"groupNotifs":{"original":"Notifiche"},"groupRecommendation":{"original":"Vicino suggerito"},"groupRecommendations":{"original":"Vicini suggeriti"},"groupExpired":{"original":"Richiesta scaduta"},"groupExpireds":{"original":"Richieste scadute"},"groupFeed":{"original":"Chiedi agli amici"},"groupFeeds":{"original":"Chiedi agli amici"},"feedPromptTitle":{"original":"Gli amici ti fanno espandere pi\u00f9 in fretta"},"feedPromptContent":{"original":"Vuoi chiedere licenze di zona agli amici?"},"feedPromptCTA":{"original":"Chiedi agli amici"},"scrollhead":{"original":"Posta in arrivo"},"sendGift":{"original":"Invia regalo"},"friends":{"original":"un amico","variations":{"indefinite_singular":"un amico","singular":"amico","plural":"amici","indefinite_plural":"alcuni amici","definite_plural":"gli amici","definite_singular":"l'amico"},"gender":"masc"}}});
// End locale-compiled/it_IT.js
