...
// Begin locale-compiled/pt_BR.js
ZLoc.init("pt_BR", {"Inbox":{"listNames":{"original":"{commaDelimNames} e {finalName}"},"followUpCTASendGiftBack":{"original":"Envie um presente"},"followUpCTASendGift":{"original":"Enviar presente"},"followUpInviteTitle":{"original":"Voc\u00ea agora \u00e9 vizinho(a) de {listNames}."},"followUpInviteBody":{"original":"Quer dizer \"oi\" enviando {gift} de presente?"},"followUpGiftBody":{"original":"Enviar um presente de agradecimento para {listNames}?"},"followUpCrewBody":{"original":"Enviar {gift} para {listNames}?"},"formatCTAAccept":{"original":"Aceitar"},"formatCTAAcceptAll":{"original":"Aceitar todos"},"formatCTAAcceptSee":{"original":"Aceitar e ver"},"formatCTAAcceptSend":{"original":"Aceitar e enviar"},"formatCTAAcceptOnly":{"original":"Somente Aceitar"},"formatCTAHelp":{"original":"Ajuda"},"formatCTASendGiftBack":{"original":"Envie um presente"},"formatCTASendGift":{"original":"Enviar presente"},"formatCTASendGifts":{"original":"Enviar presentes"},"formatGiftAggregateTitle":{"original":"Voc\u00ea recebeu {number} {gift}."},"formatGiftAggregateBody":{"original":"Aceitar presente e enviar um de volta para {listNames}?"},"formatGiftSingleTitle":{"original":"{name1} lhe enviou {gift}."},"formatGiftSingleBody":{"original":"Aceitar presente e enviar um de volta para {name1}?"},"formatInviteAggregateTitle":{"original":"Voc\u00ea tem {number} {neighbors,object,count}.","variations":["Voc\u00ea tem {number} {neighbors,fem,plural}.","Voc\u00ea tem {number} {neighbors,fem,singular}.","Voc\u00ea tem {number} {neighbors,masc,plural}.","Voc\u00ea tem {number} {neighbors,masc,singular}."]},"neighbors":{"original":"um convite de vizinho","variations":{"indefinite_singular":"um convite de vizinho","singular":"convite de vizinho","plural":"convites de vizinho","indefinite_plural":"alguns convites de vizinho","definite_plural":"os convites de vizinho","definite_singular":"o convite de vizinho"},"gender":"masc"},"formatInviteAggregateSubText":{"original":"{listNames}"},"formatInviteAggregateBody":{"original":"Avise que voc\u00ea aceitou!"},"formatInviteSingleTitle":{"original":"{name1} quer fazer parte da sua vizinhan\u00e7a em {game}."},"formatInviteSingleBody":{"original":"Voc\u00ea aceita?"},"formatHelpAggregateTitle":{"original":"Seus amigos precisam de um(a) {type}."},"formatHelpAggregateBody":{"original":"Avise eles que voc\u00ea quer ajudar."},"formatHelpAggregateSubText":{"original":"{listNames}"},"formatHelpSingleTitle":{"original":"{name1} enviou:"},"formatHelpSingleBody":{"original":"Ol\u00e1! Voc\u00ea pode me ajudar enviando um(a) {type}?"},"formatCrewAggregateTitle":{"original":"Seus amigos precisam de ajuda para construir um(a) {type}."},"formatCrewAggregateBody":{"original":"Avise-os que voc\u00ea est\u00e1 se juntando a eles."},"formatCrewAggregateSubText":{"original":"{listNames}"},"formatCrewSingleTitle":{"original":"{name1} enviou:"},"formatCrewSingleBody":{"original":"Eu preciso de voc\u00ea na equipe {crew} da minha cidade!"},"formatNotifSingleTitle":{"original":"{name1} enviou um item que voc\u00ea pediu."},"formatNotifSingleBody":{"original":"Envie um item como gratid\u00e3o!"},"formatNotifAggregateTitle":{"original":"Seus amigos enviaram itens que voc\u00ea pediu."},"formatNotifAggregateBody":{"original":"Envie um item como gratid\u00e3o!"},"formatNotifAggregateSubText":{"original":"{listNames}"},"formatExpiredTitle":{"original":"{number} {friends,object,count} amigo(s) enviou(aram) pedidos que expiraram! Verifique mais vezes!","variations":["{number} {friends,fem,plural} amigas enviaram pedidos que expiraram! Verifique mais vezes!","{number} {friends,fem,singular} amiga enviou pedidos que expiraram! Verifique mais vezes!","{number} {friends,masc,plural} amigos enviaram pedidos que expiraram! Verifique mais vezes!","{number} {friends,masc,singular} amigo enviou pedidos que expiraram! Verifique mais vezes!"]},"formatExpiredBody":{"original":"Enviar {gift} de agradecimento para: {listNames}"},"groupGift":{"original":"Presente"},"groupGifts":{"original":"Presentes"},"groupInvite":{"original":"Convite de vizinho"},"groupInvites":{"original":"Convites de vizinho"},"groupHelp":{"original":"Pedido de ajuda"},"groupHelps":{"original":"Pedidos de ajuda"},"groupCrew":{"original":"Convite de equipe"},"groupCrews":{"original":"Convites de equipe"},"groupFactory":{"original":"Convite de f\u00e1brica"},"groupFactories":{"original":"Convites de f\u00e1bricas"},"groupNotif":{"original":"Notifica\u00e7\u00e3o"},"groupNotifs":{"original":"Notifica\u00e7\u00f5es"},"groupRecommendation":{"original":"Vizinho recomendado"},"groupRecommendations":{"original":"Vizinhos recomendados"},"groupExpired":{"original":"Pedido expirado"},"groupExpireds":{"original":"Pedidos expirados"},"groupFeed":{"original":"Pedir aos amigos"},"groupFeeds":{"original":"Pedir aos amigos"},"feedPromptTitle":{"original":"Amigos tornam a expans\u00e3o mais r\u00e1pida"},"feedPromptContent":{"original":"Pedir aos amigos uma permiss\u00e3o de zoneamento?"},"feedPromptCTA":{"original":"Pedir aos amigos"},"scrollhead":{"original":"Caixa de entrada"},"sendGift":{"original":"Enviar presente"},"friends":{"original":"uma amizade","variations":{"indefinite_singular":"uma amizade","singular":"amizade","plural":"amizades","indefinite_plural":"algumas amizades","definite_plural":"as amizades","definite_singular":"a amizade"},"gender":"fem"}}});
// End locale-compiled/pt_BR.js
