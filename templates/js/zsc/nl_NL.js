...
// Begin locale-compiled/nl_NL.js
ZLoc.init("nl_NL", {"Inbox":{"listNames":{"original":"{commaDelimNames} en {finalName}"},"followUpCTASendGiftBack":{"original":"Een cadeau terugsturen"},"followUpCTASendGift":{"original":"Cadeau sturen"},"followUpInviteTitle":{"original":"Je bent nu buren met {listNames}."},"followUpInviteBody":{"original":"Wil je een {gift} als welkomstcadeau sturen?"},"followUpGiftBody":{"original":"Een bedankcadeau sturen naar {listNames}?"},"followUpCrewBody":{"original":"Een {gift} sturen naar {listNames}?"},"formatCTAAccept":{"original":"Accepteren"},"formatCTAAcceptAll":{"original":"Alles accepteren"},"formatCTAAcceptSee":{"original":"Accepteren & bekijken"},"formatCTAAcceptSend":{"original":"Accepteren en verzenden"},"formatCTAAcceptOnly":{"original":"Alleen accepteren"},"formatCTAHelp":{"original":"Help"},"formatCTASendGiftBack":{"original":"Een cadeau terugsturen"},"formatCTASendGift":{"original":"Stuur cadeau"},"formatCTASendGifts":{"original":"Cadeaus sturen"},"formatGiftAggregateTitle":{"original":"Je hebt {number} {gift} gekregen."},"formatGiftAggregateBody":{"original":"Cadeau accepteren en er een terugsturen naar {listNames}?"},"formatGiftSingleTitle":{"original":"{name1} heeft je {gift} gestuurd."},"formatGiftSingleBody":{"original":"Cadeau accepteren en er een terugsturen naar {name1}?"},"formatInviteAggregateTitle":{"original":"Je hebt {number} {neighbors,object,count}.","variations":["Je hebt {number} {neighbors,common,plural}.","Je hebt {number} {neighbors,common,singular}.","Je hebt {number} {neighbors,neuter,plural}.","Je hebt {number} {neighbors,neuter,singular}."]},"neighbors":{"original":"een burenuitnodiging","variations":{"indefinite_singular":"een burenuitnodiging","singular":"burenuitnodiging","plural":"burenuitnodigingen","indefinite_plural":"wat burenuitnodigingen","definite_plural":"de burenuitnodigingen","definite_singular":"de burenuitnodiging"}},"formatInviteAggregateSubText":{"original":"{listNames}"},"formatInviteAggregateBody":{"original":"Laat weten dat je het verzoek hebt geaccepteerd!"},"formatInviteSingleTitle":{"original":"{name1} wil je buur worden in {game}."},"formatInviteSingleBody":{"original":"Accepteer je dit verzoek?"},"formatHelpAggregateTitle":{"original":"Je vrienden hebben een {type} nodig."},"formatHelpAggregateBody":{"original":"Laat ze weten dat je wel wilt helpen."},"formatHelpAggregateSubText":{"original":"{listNames}"},"formatHelpSingleTitle":{"original":"{name1} stuurde:"},"formatHelpSingleBody":{"original":"H\u00e9 daar! Kun je me helpen door een {type} te sturen?"},"formatCrewAggregateTitle":{"original":"Je vrienden hebben hulp nodig om een {type} te bouwen."},"formatCrewAggregateBody":{"original":"Laat ze weten dat je wel wilt meehelpen."},"formatCrewAggregateSubText":{"original":"{listNames}"},"formatCrewSingleTitle":{"original":"{name1} stuurde:"},"formatCrewSingleBody":{"original":"Ik heb je nodig in de {crew}-ploeg van mijn stad!"},"formatNotifSingleTitle":{"original":"{name1} heeft een item gestuurd dat je hebt gevraagd."},"formatNotifSingleBody":{"original":"Stuur een bedankcadeau terug!"},"formatNotifAggregateTitle":{"original":"Je vrienden hebben items gestuurd die je hebt gevraagd."},"formatNotifAggregateBody":{"original":"Stuur een bedankcadeau terug!"},"formatNotifAggregateSubText":{"original":"{listNames}"},"formatExpiredTitle":{"original":"{number} {friends,object,count} hebben je verzoeken gestuurd die zijn verlopen! Kom regelmatig terug.","variations":["{number} {friends,common,plural} hebben je verzoeken gestuurd die zijn verlopen! Kom regelmatig terug.","{number} {friends,common,singular} heeft je verzoeken gestuurd die zijn verlopen! Kom regelmatig terug.","{number} {friends,neuter,plural} hebben je verzoeken gestuurd die zijn verlopen! Kom regelmatig terug.","{number} {friends,neuter,singular} heeft je verzoeken gestuurd die zijn verlopen! Kom regelmatig terug."]},"formatExpiredBody":{"original":"Stuur {gift} als bedankcadeau naar: {listNames}"},"groupGift":{"original":"Cadeau"},"groupGifts":{"original":"Cadeaus"},"groupInvite":{"original":"Burenuitnodiging"},"groupInvites":{"original":"Burenuitnodigingen"},"groupHelp":{"original":"Hulpverzoek"},"groupHelps":{"original":"Hulpverzoeken"},"groupCrew":{"original":"Ploeguitnodiging"},"groupCrews":{"original":"Ploeguitnodigingen"},"groupFactory":{"original":"Fabrieksuitnodiging"},"groupFactories":{"original":"Fabrieksuitnodigingen"},"groupNotif":{"original":"Melding"},"groupNotifs":{"original":"Meldingen"},"groupRecommendation":{"original":"Aanbevolen buur"},"groupRecommendations":{"original":"Aanbevolen buren"},"groupExpired":{"original":"Verlopen verzoek"},"groupExpireds":{"original":"Verlopen verzoeken"},"groupFeed":{"original":"Vraag vrienden"},"groupFeeds":{"original":"Vraag vrienden"},"feedPromptTitle":{"original":"Met vrienden kun je sneller uitbreiden"},"feedPromptContent":{"original":"Vrienden om een uitbreidingsvergunning vragen?"},"feedPromptCTA":{"original":"Vraag vrienden"},"scrollhead":{"original":"Postvak"},"sendGift":{"original":"Stuur cadeau"},"friends":{"original":"een vriend","variations":{"indefinite_singular":"een vriend","singular":"vriend","plural":"vrienden","indefinite_plural":"een paar vrienden","definite_plural":"de vrienden","definite_singular":"de vriend"}}}});
// End locale-compiled/nl_NL.js
