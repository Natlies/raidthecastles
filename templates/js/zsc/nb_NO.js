...
// Begin locale-compiled/nb_NO.js
ZLoc.init("nb_NO", {"Inbox":{"listNames":{"original":"{commaDelimNames} og {finalName}"},"followUpCTASendGiftBack":{"original":"Send en gave tilbake"},"followUpCTASendGift":{"original":"Send en gave"},"followUpInviteTitle":{"original":"Du er n\u00e5 nabo med {listNames}."},"followUpInviteBody":{"original":"Vil du si hei ved \u00e5 sende en gave til {gift}?"},"followUpGiftBody":{"original":"Sende en takkegave til {listNames}?"},"followUpCrewBody":{"original":"Sende {gift} til {listNames}?"},"formatCTAAccept":{"original":"Godta"},"formatCTAAcceptAll":{"original":"Godta alle"},"formatCTAAcceptSee":{"original":"Godta og se"},"formatCTAAcceptSend":{"original":"Godta og send"},"formatCTAAcceptOnly":{"original":"Kun godta"},"formatCTAHelp":{"original":"Hjelp"},"formatCTASendGiftBack":{"original":"Send en gave tilbake"},"formatCTASendGift":{"original":"Send gave"},"formatCTASendGifts":{"original":"Send gaver"},"formatGiftAggregateTitle":{"original":"Du mottok {number} {gift}."},"formatGiftAggregateBody":{"original":"Ta imot og sende en gave tilbake til {listNames}?"},"formatGiftSingleTitle":{"original":"{name1} sendte deg {gift}."},"formatGiftSingleBody":{"original":"Ta imot og sende en gave tilbake til {name1}?"},"formatInviteAggregateTitle":{"original":"Du har {number} {neighbors,object,count}.","variations":["Du har {number} {neighbors,common,plural}.","Du har {number} {neighbors,common,singular}.","Du har {number} {neighbors,neuter,plural}.","Du har {number} {neighbors,neuter,singular}."]},"neighbors":{"original":"en naboinvitasjon","variations":{"indefinite_singular":"en naboinvitasjon","singular":"naboinvitasjon","plural":"naboinvitasjoner","indefinite_plural":"noen naboinvitasjoner","definite_plural":"naboinvitasjonene","definite_singular":"naboinvitasjonen"}},"formatInviteAggregateSubText":{"original":"{listNames}"},"formatInviteAggregateBody":{"original":"Svar at du godtar dette!"},"formatInviteSingleTitle":{"original":"{name1} \u00f8nsker \u00e5 bli naboen din i {game}."},"formatInviteSingleBody":{"original":"Godtar du dette?"},"formatHelpAggregateTitle":{"original":"Vennene dine trenger en\/et {type}."},"formatHelpAggregateBody":{"original":"Svar at du gjerne vil hjelpe."},"formatHelpAggregateSubText":{"original":"{listNames}"},"formatHelpSingleTitle":{"original":"{name1} sendte:"},"formatHelpSingleBody":{"original":"Hei! Kan du hjelpe meg ved \u00e5 sende en\/et {type}?"},"formatCrewAggregateTitle":{"original":"Vennene dine trenger hjelp til \u00e5 bygge en\/et {type}."},"formatCrewAggregateBody":{"original":"Svar at du stiller opp."},"formatCrewAggregateSubText":{"original":"{listNames}"},"formatCrewSingleTitle":{"original":"{name1} sendte:"},"formatCrewSingleBody":{"original":"Jeg trenger deg i {crew}-mannskapet i byen min!"},"formatNotifSingleTitle":{"original":"{name1} sendte en gjenstand som du har bedt om."},"formatNotifSingleBody":{"original":"Send en takkegave!"},"formatNotifAggregateTitle":{"original":"Vennene dine sendte gjenstander som du har bedt om."},"formatNotifAggregateBody":{"original":"Send takkegaver!"},"formatNotifAggregateSubText":{"original":"{listNames}"},"formatExpiredTitle":{"original":"{number} {friends,object,count} sendte deg foresp\u00f8rsler som har utl\u00f8pt! Sjekk oftere!","variations":["{number} {friends,common,plural} sendte deg foresp\u00f8rsler som har utl\u00f8pt! Sjekk oftere!","{number} {friends,common,singular} sendte deg foresp\u00f8rsler som har utl\u00f8pt! Sjekk oftere!","{number} {friends,neuter,plural} sendte deg foresp\u00f8rsler som har utl\u00f8pt! Sjekk oftere!","{number} {friends,neuter,singular} sendte deg foresp\u00f8rsler som har utl\u00f8pt! Sjekk oftere!"]},"formatExpiredBody":{"original":"Send {gift} som takkegave til: {listNames}"},"groupGift":{"original":"Gave"},"groupGifts":{"original":"Gaver"},"groupInvite":{"original":"Naboinvitasjon"},"groupInvites":{"original":"Naboinvitasjoner"},"groupHelp":{"original":"Hjelpeforesp\u00f8rsel"},"groupHelps":{"original":"Hjelpeforesp\u00f8rsler"},"groupCrew":{"original":"Mannskapsinvitasjon"},"groupCrews":{"original":"Mannskapsinvitasjoner"},"groupFactory":{"original":"Fabrikkinvitasjon"},"groupFactories":{"original":"Fabrikkinvitasjoner"},"groupNotif":{"original":"Varsel"},"groupNotifs":{"original":"Varsler"},"groupRecommendation":{"original":"Anbefalt nabo"},"groupRecommendations":{"original":"Anbefalte naboer"},"groupExpired":{"original":"Utl\u00f8pt foresp\u00f8rsel"},"groupExpireds":{"original":"Utl\u00f8pte foresp\u00f8rsler"},"groupFeed":{"original":"Sp\u00f8r venner"},"groupFeeds":{"original":"Sp\u00f8r venner"},"feedPromptTitle":{"original":"Venner gj\u00f8r det lettere \u00e5 utvide"},"feedPromptContent":{"original":"Sp\u00f8rre venner om reguleringstillatelser?"},"feedPromptCTA":{"original":"Sp\u00f8r venner"},"scrollhead":{"original":"Innboks"},"sendGift":{"original":"Send gave"},"friends":{"original":"en venn","variations":{"indefinite_singular":"en venn","singular":"venn","plural":"venner","indefinite_plural":"noen venner","definite_plural":"vennene","definite_singular":"vennen"}}}});
// End locale-compiled/nb_NO.js
