...
// Begin locale-compiled/de_DE.js
ZLoc.init("de_DE", {"Inbox":{"listNames":{"original":"{commaDelimNames} und {finalName}"},"followUpCTASendGiftBack":{"original":"Geschenk schicken"},"followUpCTASendGift":{"original":"Geschenk schicken"},"followUpInviteTitle":{"original":"{listNames} und du seid jetzt Nachbarn."},"followUpInviteBody":{"original":"M\u00f6chtest du Hallo sagen, indem du Folgendes als Geschenk schickst: {gift}?"},"followUpGiftBody":{"original":"Mit einem Geschenk bei {listNames} bedanken?"},"followUpCrewBody":{"original":"{gift} an {listNames} senden?"},"formatCTAAccept":{"original":"Annehmen"},"formatCTAAcceptAll":{"original":"Alle annehmen"},"formatCTAAcceptSee":{"original":"Annehmen und ansehen"},"formatCTAAcceptSend":{"original":"Auch helfen"},"formatCTAAcceptOnly":{"original":"Nur annehmen"},"formatCTAHelp":{"original":"Hilfe"},"formatCTASendGiftBack":{"original":"Geschenk schicken"},"formatCTASendGift":{"original":"Geschenk senden"},"formatCTASendGifts":{"original":"Geschenke senden"},"formatGiftAggregateTitle":{"original":"Du hast {number} {gift} erhalten."},"formatGiftAggregateBody":{"original":"Geschenk annehmen und ein Geschenk an {listNames} zur\u00fccksenden?"},"formatGiftSingleTitle":{"original":"{name1} schickt dir: {gift}."},"formatGiftSingleBody":{"original":"Geschenk annehmen und ein Geschenk an {name1} zur\u00fccksenden?"},"formatInviteAggregateTitle":{"original":"Du hast {number} {neighbors,object,count,accusative}.","variations":["Du hast {number} {neighbors,fem,plural,accusative}.","Du hast {number} {neighbors,fem,singular,accusative}.","Du hast {number} {neighbors,masc,plural,accusative}.","Du hast {number} {neighbors,masc,singular,accusative}.","Du hast {number} {neighbors,neuter,plural,accusative}.","Du hast {number} {neighbors,neuter,singular,accusative}."]},"neighbors":{"original":"eine Nachbarneinladung","variations":{"indefinite_singular":"eine Nachbarneinladung","singular":"Nachbarneinladung","plural":"Nachbarneinladungen","indefinite_plural":"einige Nachbarneinladungen","definite_plural":"die Nachbarneinladungen","definite_singular":"die Nachbarneinladung"},"gender":"fem"},"formatInviteAggregateSubText":{"original":"{listNames}"},"formatInviteAggregateBody":{"original":"Sag Bescheid, dass du angenommen hast!"},"formatInviteSingleTitle":{"original":"{name1} m\u00f6chte bei {game} dein Nachbar sein."},"formatInviteSingleBody":{"original":"M\u00f6chtest du annehmen?"},"formatHelpAggregateTitle":{"original":"Dein Freund braucht Folgendes: {type}."},"formatHelpAggregateBody":{"original":"Sag Bescheid, dass du gerne helfen w\u00fcrdest."},"formatHelpAggregateSubText":{"original":"{listNames}"},"formatHelpSingleTitle":{"original":"{name1} schickt:"},"formatHelpSingleBody":{"original":"He! Kannst du mir helfen und mir Folgendes senden: {type}?"},"formatCrewAggregateTitle":{"original":"Dein Freund braucht Hilfe beim Bauprojekt {type}."},"formatCrewAggregateBody":{"original":"Sag Bescheid, dass du mitmachst."},"formatCrewAggregateSubText":{"original":"{listNames}"},"formatCrewSingleTitle":{"original":"{name1} schickt:"},"formatCrewSingleBody":{"original":"Ich brauche dich f\u00fcr das {crew}-Team in meiner Stadt!"},"formatNotifSingleTitle":{"original":"{name1} hat dir einen angefragten Gegenstand geschickt."},"formatNotifSingleBody":{"original":"Bedanke dich mit einem Geschenk!"},"formatNotifAggregateTitle":{"original":"Deine Freunde haben dir angefragte Gegenst\u00e4nde geschickt."},"formatNotifAggregateBody":{"original":"Bedanke dich mit einem Geschenk!"},"formatNotifAggregateSubText":{"original":"{listNames}"},"formatExpiredTitle":{"original":"{number} {friends,object,count} haben dir Anfragen geschickt, die abgelaufen sind! Du solltest \u00f6fter vorbeischauen!","variations":["{number} {friends,fem,plural} haben dir Anfragen geschickt, die abgelaufen sind! Du solltest \u00f6fter vorbeischauen!","{number} {friends,fem,singular} hat dir Anfragen geschickt, die abgelaufen sind! Du solltest \u00f6fter vorbeischauen!","{number} {friends,masc,plural} haben dir Anfragen geschickt, die abgelaufen sind! Du solltest \u00f6fter vorbeischauen!","{number} {friends,masc,singular} hat dir Anfragen geschickt, die abgelaufen sind! Du solltest \u00f6fter vorbeischauen!","{number} {friends,neuter,plural} haben dir Anfragen geschickt, die abgelaufen sind! Du solltest \u00f6fter vorbeischauen!","{number} {friends,neuter,singular} hat dir Anfragen geschickt, die abgelaufen sind! Du solltest \u00f6fter vorbeischauen!"]},"formatExpiredBody":{"original":"Sende {gift} als Dankesgeschenk an: {listNames}"},"groupGift":{"original":"Geschenk"},"groupGifts":{"original":"Geschenke"},"groupInvite":{"original":"Nachbarneinladung"},"groupInvites":{"original":"Nachbarneinladungen"},"groupHelp":{"original":"Hilfeanfrage"},"groupHelps":{"original":"Hilfeanfragen"},"groupCrew":{"original":"Teameinladung"},"groupCrews":{"original":"Teameinladungen"},"groupFactory":{"original":"Fabrikeinladung"},"groupFactories":{"original":"Fabrikeinladungen"},"groupNotif":{"original":"Benachrichtigung"},"groupNotifs":{"original":"Benachrichtigungen"},"groupRecommendation":{"original":"Nachbarnempfehlung"},"groupRecommendations":{"original":"Nachbarnempfehlungen"},"groupExpired":{"original":"Abgelaufene Anfrage"},"groupExpireds":{"original":"Abgelaufene Anfragen"},"groupFeed":{"original":"Freunde bitten"},"groupFeeds":{"original":"Freunde bitten"},"feedPromptTitle":{"original":"Freunde helfen beim Expandieren."},"feedPromptContent":{"original":"Bitte deine Freunde um eine Planungsgenehmigung."},"feedPromptCTA":{"original":"Freunde bitten"},"scrollhead":{"original":"Posteingang"},"sendGift":{"original":"Geschenk senden"},"friends":{"original":"ein Freund","variations":{"indefinite_singular":"ein Freund","singular":"Freund","plural":"Freunde","indefinite_plural":"ein paar Freunde","definite_plural":"die Freunde","definite_singular":"der Freund"},"gender":"masc"}}});
// End locale-compiled/de_DE.js
