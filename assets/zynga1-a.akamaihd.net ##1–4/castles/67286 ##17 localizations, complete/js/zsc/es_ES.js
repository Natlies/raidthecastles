...
// Begin locale-compiled/es_ES.js
ZLoc.init("es_ES", {"Inbox":{"listNames":{"original":"{commaDelimNames} y {finalName}"},"followUpCTASendGiftBack":{"original":"Env\u00eda un regalo"},"followUpCTASendGift":{"original":"Env\u00eda un regalo"},"followUpInviteTitle":{"original":"Ahora {listNames} son tus vecinos."},"followUpInviteBody":{"original":"\u00bfQuieres darles la bienvenida envi\u00e1ndoles {gift}?"},"followUpGiftBody":{"original":"\u00bfQuieres enviar un regalo de agradecimiento a {listNames}?"},"followUpCrewBody":{"original":"\u00bfQuieres enviar \"{gift}\" a {listNames}?"},"formatCTAAccept":{"original":"Aceptar"},"formatCTAAcceptAll":{"original":"Aceptar todas"},"formatCTAAcceptSee":{"original":"Aceptar y ver"},"formatCTAAcceptSend":{"original":"Aceptar y enviar"},"formatCTAAcceptOnly":{"original":"Solo aceptar"},"formatCTAHelp":{"original":"Ayuda"},"formatCTASendGiftBack":{"original":"Env\u00eda un regalo"},"formatCTASendGift":{"original":"Enviar regalo"},"formatCTASendGifts":{"original":"Env\u00eda regalos"},"formatGiftAggregateTitle":{"original":"Has recibido {number} {gift}."},"formatGiftAggregateBody":{"original":"\u00bfQuieres aceptar el regalo y enviar t\u00fa otro a {listNames}?"},"formatGiftSingleTitle":{"original":"{name1} te ha enviado \"{gift}\"."},"formatGiftSingleBody":{"original":"\u00bfQuieres aceptar el regalo y enviar t\u00fa otro a {name1}?"},"formatInviteAggregateTitle":{"original":"Tienes {number} {neighbors,object,count}.","variations":["Tienes {number} {neighbors,fem,plural}.","Tienes {number} {neighbors,fem,singular}.","Tienes {number} {neighbors,masc,plural}.","Tienes {number} {neighbors,masc,singular}."]},"neighbors":{"original":"una invitaci\u00f3n de vecino","variations":{"indefinite_singular":"una invitaci\u00f3n de vecino","singular":"invitaci\u00f3n de vecino","plural":"invitaciones de vecino","indefinite_plural":"unas invitaciones de vecino","definite_plural":"las invitaciones de vecino","definite_singular":"la invitaci\u00f3n de vecino"},"gender":"fem"},"formatInviteAggregateSubText":{"original":"{listNames}"},"formatInviteAggregateBody":{"original":"\u00a1Diles que has aceptado!"},"formatInviteSingleTitle":{"original":"{name1} quiere ser tu vecino en {game}."},"formatInviteSingleBody":{"original":"\u00bfAceptas?"},"formatHelpAggregateTitle":{"original":"Tus amigos necesitan: {type}."},"formatHelpAggregateBody":{"original":"Diles que quieres ayudarles."},"formatHelpAggregateSubText":{"original":"{listNames}"},"formatHelpSingleTitle":{"original":"{name1} ha enviado:"},"formatHelpSingleBody":{"original":"\u00a1Oye! \u00bfPodr\u00edas echarme una mano? Necesito {type}."},"formatCrewAggregateTitle":{"original":"Tus amigos necesitan que les ayudes a construir su {type}."},"formatCrewAggregateBody":{"original":"Diles que te unes a su plantilla."},"formatCrewAggregateSubText":{"original":"{listNames}"},"formatCrewSingleTitle":{"original":"{name1} ha enviado:"},"formatCrewSingleBody":{"original":"\u00a1Te necesito en la plantilla de {crew} de mi ciudad!"},"formatNotifSingleTitle":{"original":"{name1} te ha enviado el art\u00edculo que le pediste."},"formatNotifSingleBody":{"original":"\u00a1Dale las gracias con un regalo!"},"formatNotifAggregateTitle":{"original":"Tus amigos te han enviado los art\u00edculos que les pediste."},"formatNotifAggregateBody":{"original":"\u00a1Dale las gracias con un regalo!"},"formatNotifAggregateSubText":{"original":"{listNames}"},"formatExpiredTitle":{"original":"{number} {friends,object,count} te han enviado solicitudes que ya han caducado. \u00a1No olvides venir con frecuencia!","variations":["{number} {friends,fem,plural} te han enviado solicitudes que ya han caducado. \u00a1No olvides venir con frecuencia!","{number} {friends,fem,singular} te ha enviado solicitudes que ya han caducado. \u00a1No olvides venir con frecuencia!","{number} {friends,masc,plural} te han enviado solicitudes que ya han caducado. \u00a1No olvides venir con frecuencia!","{number} {friends,masc,singular} te ha enviado solicitudes que ya han caducado. \u00a1No olvides venir con frecuencia!"]},"formatExpiredBody":{"original":"Env\u00eda \"{gift}\" para darle las gracias a {listNames}"},"groupGift":{"original":"Regalo"},"groupGifts":{"original":"Regalos"},"groupInvite":{"original":"Invitaci\u00f3n de vecino"},"groupInvites":{"original":"Invitaciones de vecino"},"groupHelp":{"original":"Solicitud de ayuda"},"groupHelps":{"original":"Solicitudes de ayuda"},"groupCrew":{"original":"Invitaci\u00f3n de personal"},"groupCrews":{"original":"Invitaciones de personal"},"groupFactory":{"original":"Invitaci\u00f3n de f\u00e1brica"},"groupFactories":{"original":"Invitaciones de f\u00e1brica"},"groupNotif":{"original":"Notificaci\u00f3n"},"groupNotifs":{"original":"Notificaciones"},"groupRecommendation":{"original":"Vecino recomendado"},"groupRecommendations":{"original":"Vecinos recomendados"},"groupExpired":{"original":"Solicitud caducada"},"groupExpireds":{"original":"Solicitudes caducadas"},"groupFeed":{"original":"Pedir a amigos"},"groupFeeds":{"original":"Pedir a amigos"},"feedPromptTitle":{"original":"Con amigos, expandirte ser\u00e1 m\u00e1s f\u00e1cil"},"feedPromptContent":{"original":"\u00bfQuieres pedir a tus amigos un permiso urban\u00edstico?"},"feedPromptCTA":{"original":"Pedir a amigos"},"scrollhead":{"original":"Bandeja de entrada"},"sendGift":{"original":"Enviar regalo"},"friends":{"original":"un amigo","variations":{"indefinite_singular":"un amigo","singular":"amigo","plural":"amigos","indefinite_plural":"unos amigos","definite_plural":"los amigos","definite_singular":"el amigo"},"gender":"masc"}}});
// End locale-compiled/es_ES.js
