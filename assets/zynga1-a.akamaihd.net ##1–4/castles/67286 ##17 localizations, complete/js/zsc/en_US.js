...
// Begin locale-compiled/en_US.js
ZLoc.init("en_US", {"Inbox":{"listNames":{"original":"{commaDelimNames} and {finalName}"},"followUpCTASendGiftBack":{"original":"Send a gift back"},"followUpCTASendGift":{"original":"Send a gift"},"followUpInviteTitle":{"original":"You are now neighbors with {listNames}."},"followUpInviteBody":{"original":"Would you like to say hello by sending a gift of {gift}?"},"followUpGiftBody":{"original":"Send a thank you gift back to {listNames}?"},"followUpCrewBody":{"original":"Send a {gift} to {listNames}?"},"formatCTAAccept":{"original":"Accept"},"formatCTAAcceptAll":{"original":"Accept All"},"formatCTAAcceptSee":{"original":"Accept & See"},"formatCTAAcceptSend":{"original":"Accept & Send"},"formatCTAAcceptOnly":{"original":"Accept Only"},"formatCTAHelp":{"original":"Help"},"formatCTASendGiftBack":{"original":"Send a gift back"},"formatCTASendGift":{"original":"Send Gift"},"formatCTASendGifts":{"original":"Send Gifts"},"formatGiftAggregateTitle":{"original":"You received {number} {gift}."},"formatGiftAggregateBody":{"original":"Accept gift and send a gift back to {listNames}?"},"formatGiftSingleTitle":{"original":"{name1} sent you {gift}."},"formatGiftSingleBody":{"original":"Accept gift and send a gift back to {name1}?"},"formatInviteAggregateTitle":{"original":"You have {number} {neighbors,object,count}.","variations":["You have {number} {neighbors,plural}.","You have {number} {neighbors,singular}."]},"neighbors":{"original":"a neighbor invitation","variations":{"indefinite_singular":"a neighbor invitation","singular":"neighbor invitation","plural":"neighbor invitations","indefinite_plural":"some neighbor invitations","definite_plural":"the neighbor invitations","definite_singular":"the neighbor invitation"}},"formatInviteAggregateSubText":{"original":"{listNames}"},"formatInviteAggregateBody":{"original":"Let them know you've accepted!"},"formatInviteSingleTitle":{"original":"{name1} wants to be your neighbor in {game}."},"formatInviteSingleBody":{"original":"Would you please accept?"},"formatHelpAggregateTitle":{"original":"Your friends need a {type}."},"formatHelpAggregateBody":{"original":"Let them know you would like to help."},"formatHelpAggregateSubText":{"original":"{listNames}"},"formatHelpSingleTitle":{"original":"{name1} sent:"},"formatHelpSingleBody":{"original":"Hey! Can you help me out by sending me a {type}?"},"formatCrewAggregateTitle":{"original":"Your friends need help building a {type}."},"formatCrewAggregateBody":{"original":"Let them know you are joining them."},"formatCrewAggregateSubText":{"original":"{listNames}"},"formatCrewSingleTitle":{"original":"{name1} sent:"},"formatCrewSingleBody":{"original":"I need you on the {crew} crew in my city!"},"formatNotifSingleTitle":{"original":"{name1} sent an item you requested."},"formatNotifSingleBody":{"original":"Send them a thank you gift!"},"formatNotifAggregateTitle":{"original":"Your friends sent items that you requested."},"formatNotifAggregateBody":{"original":"Send them a thank you gift!"},"formatNotifAggregateSubText":{"original":"{listNames}"},"formatExpiredTitle":{"original":"{number} {friends,object,count} sent you requests that have expired! Check back more often!","variations":["{number} {friends,plural} sent you requests that have expired! Check back more often!","{number} {friends,singular} sent you requests that have expired! Check back more often!"]},"formatExpiredBody":{"original":"Send {gift} as a thank you gift to: {listNames}"},"groupGift":{"original":"Gift"},"groupGifts":{"original":"Gifts"},"groupInvite":{"original":"Neighbor Invitation"},"groupInvites":{"original":"Neighbor Invitations"},"groupHelp":{"original":"Help Request"},"groupHelps":{"original":"Help Requests"},"groupCrew":{"original":"Crew Invite"},"groupCrews":{"original":"Crew Invites"},"groupFactory":{"original":"Factory Invite"},"groupFactories":{"original":"Factory Invites"},"groupNotif":{"original":"Notification"},"groupNotifs":{"original":"Notifications"},"groupRecommendation":{"original":"Recommended Neighbor"},"groupRecommendations":{"original":"Recommended Neighbors"},"groupExpired":{"original":"Expired Request"},"groupExpireds":{"original":"Expired Requests"},"groupFeed":{"original":"Ask Friends"},"groupFeeds":{"original":"Ask Friends"},"feedPromptTitle":{"original":"Friends make expanding easier"},"feedPromptContent":{"original":"Ask your friends for a zoning permit?"},"feedPromptCTA":{"original":"Ask Friends"},"scrollhead":{"original":"Inbox"},"sendGift":{"original":"Send Gift"},"friends":{"original":"a friend","variations":{"indefinite_singular":"a friend","singular":"friend","plural":"friends","indefinite_plural":"some friends","definite_plural":"the friends","definite_singular":"the friend"}}}});
// End locale-compiled/en_US.js
