...
// Begin locale-compiled/sv_SE.js
ZLoc.init("sv_SE", {"Inbox":{"listNames":{"original":"{commaDelimNames} och {finalName}"},"followUpCTASendGiftBack":{"original":"Skicka en present tillbaka"},"followUpCTASendGift":{"original":"Skicka en present"},"followUpInviteTitle":{"original":"Du \u00e4r nu granne med {listNames}."},"followUpInviteBody":{"original":"Skulle du vilja s\u00e4ga hej genom att skicka en {gift} som present?"},"followUpGiftBody":{"original":"Skicka en present som tack till {listNames}?"},"followUpCrewBody":{"original":"Skicka {gift} till {listNames}?"},"formatCTAAccept":{"original":"Acceptera"},"formatCTAAcceptAll":{"original":"Acceptera alla"},"formatCTAAcceptSee":{"original":"Acceptera och visa"},"formatCTAAcceptSend":{"original":"Acceptera & skicka"},"formatCTAAcceptOnly":{"original":"Acceptera endast"},"formatCTAHelp":{"original":"Hj\u00e4lp"},"formatCTASendGiftBack":{"original":"Skicka en present tillbaka"},"formatCTASendGift":{"original":"Ge present"},"formatCTASendGifts":{"original":"Skicka presenter"},"formatGiftAggregateTitle":{"original":"Du har f\u00e5tt {number} {gift}."},"formatGiftAggregateBody":{"original":"Acceptera present och skicka en tillbaka till {listNames}?"},"formatGiftSingleTitle":{"original":"{name1} skickade {gift} till dig."},"formatGiftSingleBody":{"original":"Acceptera present och skicka en tillbaka till {name1}?"},"formatInviteAggregateTitle":{"original":"Du har {number} {neighbors,object,count}.","variations":["Du har {number} {neighbors,common,plural}.","Du har {number} {neighbors,common,singular}.","Du har {number} {neighbors,neuter,plural}.","Du har {number} {neighbors,neuter,singular}."]},"neighbors":{"original":"en granninbjudan","variations":{"indefinite_singular":"en granninbjudan","singular":"granninbjudan","plural":"granninbjudningar","indefinite_plural":"n\u00e5gra granninbjudningar","definite_plural":"granninbjudningarna","definite_singular":"granninbjudan"}},"formatInviteAggregateSubText":{"original":"{listNames}"},"formatInviteAggregateBody":{"original":"Meddela att du har accepterat!"},"formatInviteSingleTitle":{"original":"{name1} vill bli din granne i {game}."},"formatInviteSingleBody":{"original":"Vill du acceptera?"},"formatHelpAggregateTitle":{"original":"Dina v\u00e4nner beh\u00f6ver en {type}."},"formatHelpAggregateBody":{"original":"Meddela att du vill hj\u00e4lpa till."},"formatHelpAggregateSubText":{"original":"{listNames}"},"formatHelpSingleTitle":{"original":"{name1} skickade:"},"formatHelpSingleBody":{"original":"Hall\u00e5! Kan du hj\u00e4lpa till genom att skicka en {type} till mig?"},"formatCrewAggregateTitle":{"original":"Dina v\u00e4nner beh\u00f6ver hj\u00e4lp med att bygga {type}."},"formatCrewAggregateBody":{"original":"Meddela att du hakar p\u00e5."},"formatCrewAggregateSubText":{"original":"{listNames}"},"formatCrewSingleTitle":{"original":"{name1} skickade:"},"formatCrewSingleBody":{"original":"Du beh\u00f6vs i {crew}-staben i min stad!"},"formatNotifSingleTitle":{"original":"{name1} har skickat ett f\u00f6rem\u00e5l du bett om."},"formatNotifSingleBody":{"original":"Skicka en tackg\u00e5va!"},"formatNotifAggregateTitle":{"original":"Dina v\u00e4nner har skickat f\u00f6rem\u00e5l du bett om."},"formatNotifAggregateBody":{"original":"Skicka en tackg\u00e5va!"},"formatNotifAggregateSubText":{"original":"{listNames}"},"formatExpiredTitle":{"original":"{number} {friends,object,count} har skickat f\u00f6rfr\u00e5gningar som har g\u00e5tt ut! Kom tillbaka och kolla oftare!","variations":["{number} {friends,common,plural} har skickat f\u00f6rfr\u00e5gningar som har g\u00e5tt ut! Kom tillbaka och kolla oftare!","{number} {friends,common,singular} har skickat f\u00f6rfr\u00e5gningar som har g\u00e5tt ut! Kom tillbaka och kolla oftare!","{number} {friends,neuter,plural} har skickat f\u00f6rfr\u00e5gningar som har g\u00e5tt ut! Kom tillbaka och kolla oftare!","{number} {friends,neuter,singular} har skickat f\u00f6rfr\u00e5gningar som har g\u00e5tt ut! Kom tillbaka och kolla oftare!"]},"formatExpiredBody":{"original":"Skicka {gift} som tack till: {listNames}"},"groupGift":{"original":"Present"},"groupGifts":{"original":"Presenter"},"groupInvite":{"original":"Granninbjudan"},"groupInvites":{"original":"Granninbjudningar"},"groupHelp":{"original":"Hj\u00e4lpf\u00f6rfr\u00e5gan"},"groupHelps":{"original":"Hj\u00e4lpf\u00f6rfr\u00e5gningar"},"groupCrew":{"original":"Stabsinbjudan"},"groupCrews":{"original":"Stabsinbjudningar"},"groupFactory":{"original":"Fabriksinbjudan"},"groupFactories":{"original":"Fabriksinbjudningar"},"groupNotif":{"original":"Meddelande"},"groupNotifs":{"original":"Meddelanden"},"groupRecommendation":{"original":"Rekommenderad granne"},"groupRecommendations":{"original":"Rekommenderade grannar"},"groupExpired":{"original":"Utg\u00e5ngen f\u00f6rfr\u00e5gan"},"groupExpireds":{"original":"Utg\u00e5ngna f\u00f6rfr\u00e5gningar"},"groupFeed":{"original":"Be v\u00e4nner"},"groupFeeds":{"original":"Be v\u00e4nner"},"feedPromptTitle":{"original":"V\u00e4nner g\u00f6r det l\u00e4ttare att expandera"},"feedPromptContent":{"original":"Be dina v\u00e4nner om ett zonindelningstillst\u00e5nd?"},"feedPromptCTA":{"original":"Be v\u00e4nner"},"scrollhead":{"original":"Inkorg"},"sendGift":{"original":"Ge present"},"friends":{"original":"en v\u00e4n","variations":{"indefinite_singular":"en v\u00e4n","singular":"v\u00e4n","plural":"v\u00e4nner","indefinite_plural":"n\u00e5gra v\u00e4nner","definite_plural":"v\u00e4nnerna","definite_singular":"v\u00e4nnen"}}}});
// End locale-compiled/sv_SE.js
